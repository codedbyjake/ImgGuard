...
Multi-page, multi-frame and container formats are scanned all the way through. Video is sampled across its runtime, favouring scene changes. The worst score across everything scanned is the one that counts.
